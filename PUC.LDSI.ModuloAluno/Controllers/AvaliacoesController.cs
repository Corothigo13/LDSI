...
namespace PUC.LDSI.ModuloAluno.Controllers
{
    public class AvaliacoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProfessorId,Disciplina,Materia,Descricao,Id")] Avaliacao avaliacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProfessorId,Disciplina,Materia,Descricao,Id")] Avaliacao avaliacao)
        {
            if (id != avaliacao.Id)
            {
                return NotFound();
