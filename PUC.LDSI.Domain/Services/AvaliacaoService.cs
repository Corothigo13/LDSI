...
namespace PUC.LDSI.Domain.Services
{
    ...
    public async Task<Avaliacao> ObterAsync(int? id)
        ...
        public async Task<Questao> ObterQuestaoAsync(int id)
        {
            var questao = await _questaoRepository.ObterAsync(id);
        ...
        public async Task<OpcaoAvaliacao> ObterOpcaoAvaliacaoAsync(int? id)
        {
            if (id == null) return null;

            var opcao = await _opcaoAvaliacaoRepository.ObterAsync(id.Value);
