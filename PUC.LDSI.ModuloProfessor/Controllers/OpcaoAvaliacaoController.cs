...
namespace PUC.LDSI.ModuloProfessor.Controllers
{
    public class OpcaoAvaliacaoController : BaseController
    {
        ...
        public OpcaoAvaliacaoController(UserManager<Usuario> user, IAvaliacaoService avaliacaoService) : base(user)
        {
        ...
        {
            var opcaoAvaliacao = await _avaliacaoService.ObterOpcaoAvaliacaoAsync(id);
